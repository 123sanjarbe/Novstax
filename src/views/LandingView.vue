  ...
  <div class="landing-root">
    <div class="hero-crest-wrap reveal-up">
      <section id="top" class="hero-crest">
        <div class="hero-crest__bg" :style="{ backgroundImage: `url(${JSON.stringify(HERO_CREST_BG)})` }" />
        ...
        <div class="hero-crest__inner">
          ...
          <div class="hero-crest__cta-row">
            <a class="btn btn-primary" href="https://Novstax.gomc.uz" target="_blank" rel="noopener noreferrer">{{ t("server.site") }}</a>
    ...
    <section id="tokens" class="section section--tight reveal-up">
      ...
      <div class="token-grid">
        <GlowCard v-for="p in tokenPacks" :key="p.amount">
          <div class="rank-top">
      ...
      <div class="keys-row">
        <GlowCard v-for="k in donateKeys" :key="k.id" :elevated="k.highlight">
          <div class="rank-top">
    ...
    <section id="contact" class="section section--tight reveal-up">
      ...
      <GlowCard elevated>
        <div class="form">
          ...
          <button type="button" class="btn btn-primary btn--inline" @click="sendContact">{{ t("contactPage.send") }}</button>
        </div>
      </GlowCard>
    </section>
  </div>
